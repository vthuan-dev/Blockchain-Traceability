...
const app = express();
app.use(cors()); // Cho phép CORS để client có thể gọi API
app.use(bodyParser.json());
app.use(express.urlencoded({ extended: true })); // Thêm middleware để xử lý dữ liệu URL-encoded
app.use(fileUpload()); // Thêm middleware để xử lý file upload
